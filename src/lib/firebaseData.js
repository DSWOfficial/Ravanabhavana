...
const tableConfig = {
  ...
  site_settings: {
    ...
    fields: {
      ...
      theme_page_background: 'theme_page_background',
      theme_section_background: 'theme_section_background',
      theme_surface_background: 'theme_surface_background',
      theme_text_color: 'theme_text_color',
      theme_muted_color: 'theme_muted_color',
      theme_primary_color: 'theme_primary_color',
      theme_primary_hover_color: 'theme_primary_hover_color',
      theme_accent_color: 'theme_accent_color',
      theme_secondary_accent_color: 'theme_secondary_accent_color',
      theme_hero_background: 'theme_hero_background',
      theme_hero_text_color: 'theme_hero_text_color',
      updated_at: 'updatedAt',
    },
  },
  donation_settings: {
