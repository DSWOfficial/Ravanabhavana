...
const liveTranslations = {
  si: {
    title: 'රාවණ භවණ සජීවී',
    subtitle: 'සජීවී වැඩසටහන් වෙබ් අඩවිය තුළම Jitsi හරහා පැවැත්වේ.',
    liveSessions: 'සජීවී වැඩසටහන්',
    joinLive: 'සජීවී වැඩසටහනට එක්වන්න',
    joinNow: 'දැන් එක්වන්න',
    liveNow: 'සජීවී වැඩසටහන දැන් පැවැත්වේ',
    sessionLiveNow: 'වැඩසටහන දැන් සජීවීව පවතී',
    startsIn: 'වැඩසටහන ආරම්භ වීමට ඉතිරි කාලය',
    ended: 'මෙම වැඩසටහන අවසන් වී ඇත',
    addCalendar: 'කැලැන්ඩරයට එක් කරන්න',
    resources: 'සම්පත්',
    host: 'මෙහෙයවන්නා',
    startLive: 'සජීවීව ආරම්භ කරන්න',
    endLive: 'සජීවී වැඩසටහන අවසන් කරන්න',
    recording: 'පටිගත කිරීම',
    sessionRecording: 'සැසි පටිගත කිරීම',
    watchRecording: 'පටිගත කිරීම නරඹන්න',
    obs: 'OBS Studio',
    recordingUrl: 'පටිගත කිරීමේ සබැඳිය',
    publishRecording: 'පටිගත කිරීම පළ කරන්න',
    meetingRoom: 'සජීවී කාමරය',
    copyLink: 'සබැඳිය පිටපත් කරන්න',
    empty: 'ඊළඟ සජීවී වැඩසටහන ඉක්මනින් දැනුම් දෙනු ඇත.',
    upcoming: 'ඉදිරි සජීවී වැඩසටහන්',
    recordings: 'පටිගත කළ වැඩසටහන්',
    details: 'විස්තර බලන්න',
    loginFirst: 'කරුණාකර පළමුව පිවිසෙන්න',
    recordingNotPublished: 'මෙම සැසියේ පටිගත කිරීම තවම පළ කර නැත.',
    meetingNotice: 'හොඳ අත්දැකීමක් සඳහා, අවශ්‍ය වන තුරු ඔබගේ මයික්‍රොෆෝනය සහ කැමරාව ක්‍රියාත්මක නොකරන්න.',
    meetingFeatures: 'මෙම සජීවී කාමරය තුළ ඔබට මයික්‍රොෆෝනය, කැමරාව, chat, raise hand සහ screen share පහසුකම් භාවිතා කළ හැක.',
    meetingEtiquette: 'සැසිය සුමටව පැවැත්වීම සඳහා, අවශ්‍ය වන තුරු ඔබගේ මයික්‍රොෆෝනය සහ කැමරාව නිශ්ශබ්දව තබන්න.',
    upcomingStatus: 'ඉදිරියට පැවැත්වේ',
    offlineStatus: 'Offline',
    replayAvailable: 'නැවත නැරඹිය හැක',
    watchYoutube: 'YouTube හි නරඹන්න',
    subscribe: 'Subscribe',
  },
  en: {
    title: 'Ravana Bhavana Live',
    subtitle: 'Live sessions are hosted inside the website through Jitsi.',
    liveSessions: 'Live Sessions',
    joinLive: 'Join Live Session',
    joinNow: 'Join Now',
    liveNow: 'Live session is happening now',
    ...
    publishRecording: 'Publish Recording',
    meetingRoom: 'Meeting Room',
    copyLink: 'Copy Link',
    empty: 'The next live session will be announced soon.',
    upcoming: 'Upcoming Live Sessions',
    recordings: 'Recorded Sessions',
    details: 'View details',
    loginFirst: 'Please log in first',
    recordingNotPublished: 'The recording for this session has not been published yet.',
    meetingNotice: 'For the best experience, please keep your microphone and camera off unless needed.',
    meetingFeatures: 'Inside this live room, you can use microphone, camera, chat, raise hand, and screen sharing features.',
    meetingEtiquette: 'To keep the session smooth, please keep your microphone muted and camera off unless needed.',
...
export function getNestedTranslation(language, key) {
  if (key.startsWith('live.')) return liveTranslations[language]?.[key.slice(5)] || liveTranslations.en[key.slice(5)] || key;
